...
public class ModWorkflowBuilderFactory {
	...
	@Inject
	ModWorkflowBuilderFactory(ConfigFactory configFactory, CrawlerFactory crawlerService, ModUpdateCoordinator updateCoordinator, ModMetaHelper modMetaHelper) {
